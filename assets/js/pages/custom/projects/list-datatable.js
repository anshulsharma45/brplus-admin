      ...
      columns: [
        {
          ...
          template: function (data) {
            return (
              '<span class="font-weight-bolder">' + data.RecordID + "</span>"
            );
          },
        },
        {
              ...
              output =
                '<div class="d-flex align-items-center">\
								<div class="symbol symbol-40 symbol-circle symbol-sm">\
									<img class="" src="assets/media/project-logos/' +
                img +
                '" alt="photo"/>\
								</div>\
								<div class="ml-3">\
        ...
        },
        {
          ...
          template: function (row) {
            ...
            output +=
              ...
              "</div>";
            output +=
              '<div class="font-weight-bold text-muted">Code: ' +
              row.ShipCountry +
              "</div>";
        ...
        },
        {
          ...
          template: function (row) {
            ...
            output +=
              ...
              "</div>";
            output +=
              '<div class="text-muted">' + status[index].title + "</div>";
                                ...
                                <ul class="navi flex-column navi-hover py-2">\
                                    ...
                                    <li class="navi-item">\
                                        <a href="#" class="navi-link">\
                                            ...
                                            <span class="navi-text">Print 23</span>\
                                        </a>\
                                    </li>\
                                    <li class="navi-item">\
                                        <a href="#" class="navi-link">\
